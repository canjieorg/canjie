...
<Tabs>
  <TabItem label="npm">
    ...
    ```bash
    npm create astro@latest -- --template tgimgcdn/canjie blog && cd blog && npm install
    ```
  ...
  <TabItem label="pnpm">
    ...
    ```bash
    pnpm create astro@latest -- --template tgimgcdn/canjie blog && cd blog && pnpm install
    ```
  ...
  <TabItem label="yarn">
    ...
    ```bash
    yarn create astro --template tgimgcdn/canjie blog && cd blog && yarn install
    ```
